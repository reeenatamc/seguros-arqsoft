...
from app.models import GrupoRamo, SubgrupoRamo, TipoRamo
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        with transaction.atomic():
            ...
            catalogo = [
                ...
                },
                {
                    ...
                    "subgrupos": [
                        (
                            "TIN",
                            "Póliza de transporte interno",
                            "Transporte de mercancías dentro del territorio nacional",
                            1,
                        ),
                ...
                },
                {
                    ...
                    "subgrupos": [
                        ...
                        (
                            ...
                            "D&O - Responsabilidad de directores y administradores",
                            3,
                        ),
                ...
                },
                {
                    ...
                    "subgrupos": [
                        ...
                        (
                            "APP",
                            "Accidentes personales personal de proyecto",
                            "Cobertura para personal de proyectos",
                            3,
                        ),
                    ],
                },
            ...
            self.stdout.write(self.style.SUCCESS("¡Catálogo de ramos poblado exitosamente!"))
