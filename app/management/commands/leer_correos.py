        ...
        try:
            ...
            with EmailReaderService() as service:
                ...
                if not reportes:
                    ...
                    self.stdout.write(self.style.WARNING("No se encontraron correos de siniestros que procesar."))
                ...
                self.stdout.write(self.style.SUCCESS(f"✓ Se encontraron {len(reportes)} correo(s) de siniestros:"))
                    ...
                    if not dry_run:
                        ...
                        try:
                            ...
                            siniestro_email, siniestro, mensaje = guardar_reporte_en_bd(
                                reporte, intentar_crear_siniestro=auto_create
                            )
                            ...
                            if siniestro:
                                ...
                                self.stdout.write(self.style.WARNING("    ⚠️  Ya existía en el sistema"))

                            else:

                                pendientes += 1

                                self.stdout.write(self.style.WARNING(f"    📋 PENDIENTE: {mensaje[:60]}..."))
                            ...
                            self.stdout.write(self.style.ERROR(f"    ❌ ERROR al guardar: {str(e)[:60]}"))
                ...
                if not dry_run:
                    ...
                    self.stdout.write(self.style.WARNING("⚠ MODO DRY-RUN: Los datos NO fueron guardados."))

                    self.stdout.write(self.style.WARNING("  Ejecute sin --dry-run para guardar en la BD."))
