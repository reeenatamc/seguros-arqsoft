...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("backup_file", nargs="?", type=str, help="Archivo de backup a restaurar")
        ...
        parser.add_argument("--compressed", "-c", action="store_true", help="El archivo está comprimido con gzip")

        parser.add_argument("--no-confirm", action="store_true", help="No pedir confirmación antes de restaurar")

        parser.add_argument(
            "--backup-first", action="store_true", default=True, help="Crear backup antes de restaurar (default: True)"
        )

        parser.add_argument("--skip-backup", action="store_true", help="No crear backup antes de restaurar")
    ...
    def _restore_data(self, backup_file, backup_format):
        ...
        call_command("loaddata", str(backup_file), format=backup_format, verbosity=1)
