...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        siniestros = self.crear_siniestros_completos(polizas, tipos_siniestro, responsables, admin_user)
    ...
    def crear_tipos_siniestro_si_no_existen(self):
        ...
        for nombre in tipos_data:
            ...
            tipo, _ = TipoSiniestro.objects.get_or_create(nombre=nombre, defaults={"activo": True})
    ...
    def crear_siniestros_completos(self, polizas, tipos_siniestro, responsables, usuario):
        ...
        for i in range(30):
            ...
            if tiene_respuesta and "fecha_envio_aseguradora" in data:
                ...
                data["fecha_respuesta_aseguradora"] = data["fecha_envio_aseguradora"] + timedelta(
            ...
            if tiene_pago and "fecha_liquidacion" in data:
                ...
                data["valor_pagado"] = data.get("monto_indemnizado", monto_estimado) - data.get(
                    "deducible_aplicado", Decimal("0")
                )
            ...
            try:
                ...
                _siniestro = Siniestro.objects.create(**data)  # noqa: F841
