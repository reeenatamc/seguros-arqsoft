...
urlpatterns = [
    ...
    path('siniestros/<int:pk>/email-preview/<str:tipo>/', views.siniestro_email_preview, name='siniestro_email_preview'),
    ...
    path('siniestros/<int:pk>/enviar-liquidacion/', views.siniestro_enviar_liquidacion, name='siniestro_enviar_liquidacion'),
    path('siniestros/<int:pk>/registrar-liquidacion/', views.siniestro_registrar_liquidacion, name='siniestro_registrar_liquidacion'),
