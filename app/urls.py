...
urlpatterns = [
    ...
    path("bienes/", views.assets_list, name="bienes_lista"),  # Alias
    # Calendario
    ...
    # API para vista previa de emails (Modal)
    path(
        "siniestros/<int:pk>/email-preview/<str:tipo>/", views.siniestro_email_preview, name="siniestro_email_preview"
    ),
    path("siniestros/<int:pk>/email-enviar/<str:tipo>/", views.siniestro_email_enviar, name="siniestro_email_enviar"),
    ...
    path(
        "siniestros/<int:pk>/marcar-docs-listos/",
        views.siniestro_marcar_docs_listos,
        name="siniestro_marcar_docs_listos",
    ),
    ...
    path("siniestros/<int:pk>/resolver-disputa/", views.siniestro_resolver_disputa, name="siniestro_resolver_disputa"),
    path(
        "siniestros/<int:pk>/enviar-liquidacion/",
        views.siniestro_enviar_liquidacion,
        name="siniestro_enviar_liquidacion",
    ),
    path(
        "siniestros/<int:pk>/registrar-liquidacion/",
        views.siniestro_registrar_liquidacion,
        name="siniestro_registrar_liquidacion",
    ),
    path("siniestros/<int:pk>/cerrar/", views.siniestro_cerrar, name="siniestro_cerrar"),
    path("siniestros/<int:pk>/rechazar/", views.siniestro_rechazar, name="siniestro_rechazar"),
    # Adjuntos
