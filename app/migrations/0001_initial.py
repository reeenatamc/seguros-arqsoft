# Generated by Django 5.2.9 on 2026-01-22 22:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grupo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bienes', to='app.grupobienes', verbose_name='Grupo de Bienes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('created_by', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Creado por')),
                ('grupo', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='app.grupobienes', verbose_name='Grupo de Bienes')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            ...
            name='responsable',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='grupos_bienes', to='app.responsablecustodio', verbose_name='Responsable'),
        ),
        migrations.CreateModel(
            name='BienAsegurado',
            fields=[
                ...
                ('estado', models.CharField(choices=[('activo', 'Activo'), ('inactivo', 'Inactivo'), ('dado_de_baja', 'Dado de Baja'), ('siniestrado', 'Siniestrado')], default='activo', max_length=20, verbose_name='Estado')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deducible', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True, verbose_name='Deducible')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activo_encontrado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='siniestros_email', to='app.insuredasset', verbose_name='Activo Encontrado')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['asset_code'], name='app_insured_asset_c_9a63d8_idx'),
        ),
        migrations.AddIndex(
            model_name='insuredasset',
            index=models.Index(fields=['status'], name='app_insured_status_497bac_idx'),
        ),
        migrations.AddIndex(
            model_name='insuredasset',
            index=models.Index(fields=['category'], name='app_insured_categor_9d53c6_idx'),
        ),
        migrations.AddIndex(
