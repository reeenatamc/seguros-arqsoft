...
class FacturaService(BaseService):
    ...
    def calcular_descuento_pronto_pago(
        ...
        """Delega a FacturaCalculationService."""
        from ..calculations import FacturaCalculationService
        return FacturaCalculationService.calcular_descuento_pronto_pago(
    ...
    def calcular_monto_total(
        ...
        return FacturaCalculationService.calcular_monto_total(
            subtotal, iva, contribucion_super, contribucion_campesino,
    ...
    def determinar_estado(
        ...
        """Delega a FacturaCalculationService."""
        from ..calculations import FacturaCalculationService
        return FacturaCalculationService.determinar_estado_factura(
        ...
        **kwargs
        ...
        try:
            ...
            return ResultadoOperacion.fallo(
                {'__all__': str(e)},
                f"Error al crear factura: {str(e)}"
            )
