...
class PDFReportesService:
    ...
    def _data_table(cls, headers, rows, col_widths=None):
        ...
        for row in rows:
            ...
            for i, cell in enumerate(row):
                ...
                style = s['RptCellRight'] if (txt.startswith('$') or (txt.replace(',', '').replace('.', '').isdigit())) else s['RptCell']
    ...
    def generar_reporte_polizas_pdf(cls, reporte_data, filtros_texto=None):
        ...
        doc = SimpleDocTemplate(buffer, pagesize=cls.PAGE_SIZE,

                               leftMargin=cls.MARGIN, rightMargin=cls.MARGIN,
        ...
        if total > 35:
            ...
            elements.append(Paragraph(
                ...
                f"Mostrando 35 de {total} registros. Exporte a Excel para ver todos.",
        ...
        if rows:
            ...
            elements.append(cls._data_table(
                ...
                [cls.WIDTH*0.15, cls.WIDTH*0.22, cls.WIDTH*0.13, cls.WIDTH*0.18, cls.WIDTH*0.18, cls.WIDTH*0.14]
    ...
    def generar_reporte_siniestros_pdf(cls, reporte_data, filtros_texto=None):
        ...
        if monto_est > 0:
            ...
            elements.append(cls._indicator_box(
        ...
        if totales.get('rechazados') and totales.get('cantidad'):
            ...
            elements.append(cls._indicator_box(
                ...
                f"<b>Tasa de Rechazo:</b> {tasa:.1f}% de los siniestros han sido rechazados."
        ...
        if por_estado:
            ...
            estado_map = {
                ...
                'registrado': 'Registrado', 'documentacion_pendiente': 'Documentación Pendiente',

                'enviado_aseguradora': 'Enviado', 'en_evaluacion': 'En Evaluación',

                'aprobado': 'Aprobado', 'rechazado': 'Rechazado',

                'liquidado': 'Liquidado', 'cerrado': 'Cerrado',
        ...
        if total > 35:
            ...
            elements.append(Paragraph(
                ...
                f"Mostrando 35 de {total} registros.",
        ...
        if rows:
            ...
            elements.append(cls._data_table(
                ...
                [cls.WIDTH*0.12, cls.WIDTH*0.12, cls.WIDTH*0.12, cls.WIDTH*0.10, cls.WIDTH*0.15, cls.WIDTH*0.15, cls.WIDTH*0.24]
    ...
    def generar_reporte_facturas_pdf(cls, reporte_data, filtros_texto=None):
        ...
        if total_fact > 0:
            ...
            elements.append(cls._indicator_box(
                ...
                f"<b>Cartera Pendiente:</b> {pct:.1f}% del total facturado está por cobrar."
        ...
        if rows:
            ...
            elements.append(cls._data_table(
                ...
                [cls.WIDTH*0.12, cls.WIDTH*0.12, cls.WIDTH*0.11, cls.WIDTH*0.11, cls.WIDTH*0.16, cls.WIDTH*0.16, cls.WIDTH*0.22]
